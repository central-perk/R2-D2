...
var crypto, fs, getUTC, moment, path, pm2, validateLength, validateMaxLength, validateMaxMinLength, validateMinLength, _;
...
module.exports = {
  setG: function(rootPath) {
    var app, config, libs, packageJSON, pub, self;
    self = this;
    ...
    return process.g.packageJSON = packageJSON;
  },
