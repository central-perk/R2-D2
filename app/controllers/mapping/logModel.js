...
var Schema, async, attrLegal, attrLowerCase, auth, config, logModel, logModelDao, mongoose, oAttrValueMap, utils, _;
...
attrLowerCase = function(aAttr) {
  _.each(aAttr, function(oAttr, index) {
    return aAttr[index].name = oAttr.name.toLowerCase();
  });
  console.log(aAttr);
  return aAttr;
};
