...
var LOGGERFILE_STATUS, STORAGE_MAXLINES, appCtrl, async, config, filePath, fs, json2db, kueCtrl, log2json, logCtrl, loggerFileCtrl, loggersPath, mongoose, utils, _;
...
module.exports = {
  ...
  list: function(req, res) {
    var Model, appID, loggerName, name, query;
    query = req.query;
    appID = query.app;
    name = query.name;
    loggerName = "" + appID + "." + name;
    Model = mongoose.model(loggerName);
    return Model.find({}, function(err, loggers) {
      if (!err) {
